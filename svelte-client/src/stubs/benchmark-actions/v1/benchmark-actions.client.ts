...
/**
 * @generated from protobuf service benchmarkActions.BenchmarkActionsService
 */
export interface IBenchmarkActionsServiceClient {
    /**
     * Unary
     *
     * @generated from protobuf rpc: BigArrayProcess(benchmarkActions.BigArrayProcessRequest) returns (benchmarkActions.BigArrayProcessResponse);
     */
    bigArrayProcess(input: BigArrayProcessRequest, options?: RpcOptions): UnaryCall<BigArrayProcessRequest, BigArrayProcessResponse>;
    /**
     * @generated from protobuf rpc: BigDbFetch(benchmarkActions.BigDbFetchRequest) returns (benchmarkActions.BigDbFetchResponse);
     */
